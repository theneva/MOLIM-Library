...
export default class Home extends React.Component {
    ...
    render() {
        return <div style={styles.container}>
            ...
            <p>This library was created as part of the <a href="http://www.exomol.com">ExoMol</a> and the <a href="http://www.cost-molim.eu">MOLIM</a> projects, with the work carried out by Cameron Voisey in collaboration with Dr Sergey Yurchenko.</p>
