    ...
    return <div style={styles.container}>
      ...
      <div style={styles.listContainer}>
        ...
        <MoleculeList type="Triatomics"
          nameArray={this.props.molecules.filter((molecule)=>molecule.numberOfAtoms==3)}
          changePageState={this.props.changePageState}/>
        <MoleculeList type="Tetratomics"
          nameArray={this.props.molecules.filter((molecule)=>molecule.numberOfAtoms==4)}
          changePageState={this.props.changePageState}/>
        <MoleculeList type="Pentatomics"
          nameArray={this.props.molecules.filter((molecule)=>molecule.numberOfAtoms==5)}
          changePageState={this.props.changePageState}/>
        <MoleculeList type="Hexatomics"
          nameArray={this.props.molecules.filter((molecule)=>molecule.numberOfAtoms==6)}
          changePageState={this.props.changePageState}/>
      </div>
    </div>
  }
