    ...
    render() {
        return <div style={styles.container}>
            ...
            <div className="col-md-7">
                ...
                <div className="img-rounded" style={styles.sectionContainer}><h5>Title:</h5>
                    <p>{this.props.data.paperTitle}</p>
            ...
            <div className="col-md-5">
                <h3>Links</h3>
                <div className="img-rounded" style={styles.sectionContainer}><h5>DOI:</h5><a
                    href={"http://dx.doi.org/" + this.props.data.DOI}>{this.props.data.DOI}</a>
                    <h5>Supplementary Material:</h5><a
                        href={this.props.data.supplementaryLink}>{this.props.data.supplementaryLink}</a></div>
                <h3>References</h3>
                <div className="img-rounded" style={styles.sectionContainer}><h5>Reference 1:</h5>
                    <p>{this.props.data.references.one}</p>
                    <h5>Reference 2:</h5><p>{this.props.data.references.two}</p></div>
                <h3>Contact</h3>
                <div className="img-rounded" style={styles.sectionContainer}><h5>Email:</h5>
                    <p>{this.props.data.email}</p></div>
            </div>
        </div>
    }
}
